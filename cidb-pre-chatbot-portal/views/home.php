...
<?php $fields=[['name','Name','text','e.g. Aisyah binti Abdullah','Enter your full name as shown on your ID',200],['id_number','ID Number','text','e.g. 900101-14-5678','Enter your Malaysian ID or other valid ID number',40],['email','Email','email','e.g. name@example.com','Enter your email address',254],['location_area','Location Area','text','e.g. W.P. Kuala Lumpur','Enter the area for this request',120],['crm','CRM','text','Enter your CRM','Provide the CRM reference for this request',120]]; foreach($fields as [$key,$label,$type,$placeholder,$help,$maxlength]): ?>
